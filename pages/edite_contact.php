...
<div class="row animated fadeIn">
    ...
    <div style="width: 94%;margin-right: 3%;">
        <form role="form">
            <div class="form-group col-lg-6">
                <label>نام خانوادگی </label>
                <input class="form-control" required name="contact-family" echo="<?php echo $row['family']; ?>" tabindex="2">
            </div>
            <div class="form-group col-lg-6">
                <label>نام</label>
                <input class="form-control" name="contact-name" autofocus echo="<?php echo $row['name']; ?>" tabindex="1">
            </div>
            <div class="form-group col-lg-6">
                <label>رسمی / غیر رسمی</label>
                <select class="form-control" required name="contact-official" tabindex="4">
            ...
            <div class="form-group col-lg-6">
                ...
                <select class="form-control" required id="contact-category" tabindex="3">
                    <?php
            ...
            <div class="form-group col-lg-6">
                ...
                <select class="form-control" required id="contact-gender" tabindex="6">
                    ...
                    <option value="3" selected="">نامعلوم</option>
                </select>
            </div>
            <div class="form-group col-lg-6">
                <label>عنوان</label>
    ...
    <div style="width: 94%;margin-right: 3%;">
        ...
        &nbsp;&nbsp;
        <button type="submit" class="btn btn-primary ">افزودن مخاطب</button>
    </div>
  </form>
</div>
